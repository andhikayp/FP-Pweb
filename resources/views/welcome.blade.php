...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Netijen</a>
            ...
            <li class="nav-item">
             ...
             @if (Route::has('login'))
              {{--   <div class="top-right links"> --}}
                    @auth
                    <li class="nav-item">
                        <a class="nav-link disabled" href="{{ url('/home') }}"><h6>Home</h6></a>
                    </li>
                    @else
                    <li class="nav-item">
                        <a class="nav-link disabled" href="{{ route('login') }}"><h6>Login</h6></a>
                    </li>
                        @if (Route::has('register'))
                        <li class="nav-item">
                            <a class="nav-link disabled" href="{{ route('register') }}"><h6>Register</h6></a>
                        </li>
                        @endif
                    @endauth
            {{--     </div> --}}
